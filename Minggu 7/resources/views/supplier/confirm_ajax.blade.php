                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="text-left col-9">{{ $supplier->supplier_kode }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama supplier</th>
                            <td class="text-left col-9">{{ $supplier->supplier_nama }}</td>
                        </tr>
                    </table>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                                ...
                                // Asumsikan 'dataSupplier' adalah variabel DataTable Anda
