                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="text-left col-9">{{ $kategori->kategori_kode }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama Kategori</th>
                            <td class="text-left col-9">{{ $kategori->kategori_nama }}</td>
                        </tr>
                    </table>
                </div>
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            if (typeof dataKategori !== 'undefined') {
                                dataKategori.ajax.reload(); // ganti sesuai nama datatable kamu
                            }
                        } else {
                            Swal.fire({
                                icon: 'error',
